...
class DetailEventActivity : AppCompatActivity(),
    DetailEventContract.DetailEventView, View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = DetailEventPresenter(
            this,
            GetDetailEvent(dataEvent.idEvent.toString())
        )
    ...
    private fun removeFromFavorite(event : EventsItem){
        try {
            database.use {
                delete(Favorite.TABLE_FAVORITE_EVENT, "(EVENT_ID = {id_event})",
    ...
    private fun addToFavorite(event : EventsItem){
        try {
            database.use {
                insert(Favorite.TABLE_FAVORITE_EVENT,
    ...
    private fun favoriteState(idEvent : String){
        database.use {
            val result = select(Favorite.TABLE_FAVORITE_EVENT)
